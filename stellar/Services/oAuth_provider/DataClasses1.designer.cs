...
namespace stellar.Services.oAuth_provider
{
    ...
    partial void UpdateUser(OAuthAuthorizationServer.Code.User instance);
    partial void DeleteUser(OAuthAuthorizationServer.Code.User instance);
    partial void InsertClient(OAuthAuthorizationServer.Code.Client instance);
    partial void UpdateClient(OAuthAuthorizationServer.Code.Client instance);
    partial void DeleteClient(OAuthAuthorizationServer.Code.Client instance);
    partial void InsertClientAuthorization(OAuthAuthorizationServer.Code.ClientAuthorization instance);
    partial void UpdateClientAuthorization(OAuthAuthorizationServer.Code.ClientAuthorization instance);
    ...
    partial void UpdateNonce(OAuthAuthorizationServer.Code.Nonce instance);
    partial void DeleteNonce(OAuthAuthorizationServer.Code.Nonce instance);
    partial void InsertSymmetricCryptoKey(OAuthAuthorizationServer.Code.SymmetricCryptoKey instance);
    partial void UpdateSymmetricCryptoKey(OAuthAuthorizationServer.Code.SymmetricCryptoKey instance);
    partial void DeleteSymmetricCryptoKey(OAuthAuthorizationServer.Code.SymmetricCryptoKey instance);
		...
		public System.Data.Linq.Table<OAuthAuthorizationServer.Code.User> Users
		{
			get
			{
				return this.GetTable<OAuthAuthorizationServer.Code.User>();
			}
		}
		
		public System.Data.Linq.Table<OAuthAuthorizationServer.Code.Client> Clients
		{
			get
			{
				return this.GetTable<OAuthAuthorizationServer.Code.Client>();
			}
		}
		
		public System.Data.Linq.Table<OAuthAuthorizationServer.Code.ClientAuthorization> ClientAuthorizations
		{
			get
			{
				return this.GetTable<OAuthAuthorizationServer.Code.ClientAuthorization>();
			}
		}
		
		public System.Data.Linq.Table<OAuthAuthorizationServer.Code.Nonce> Nonces
		{
			get
			{
				return this.GetTable<OAuthAuthorizationServer.Code.Nonce>();
			}
		}
		
		public System.Data.Linq.Table<OAuthAuthorizationServer.Code.SymmetricCryptoKey> SymmetricCryptoKeys
		{
			get
			{
				return this.GetTable<OAuthAuthorizationServer.Code.SymmetricCryptoKey>();
			}
		}
	}
}
