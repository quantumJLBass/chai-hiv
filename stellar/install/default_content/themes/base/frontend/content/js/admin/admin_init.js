...
$(function () {
		...
		$("#change_content_source").on("click",function(e){
			...
			if(!$(this).is(":checked")){
				if ($("#choose_ur_fate").length == 0) {
					$("body").append('<div id="choose_ur_fate"><strong>Choose how you wouldd like to conversion your current state of this item.</strong></div>');
				}
				$("#choose_ur_fate").dialog({
					...
					open:function( event, ui ) {
						...
						$('#wsu_ui_default .ui-widget-overla').css({"position":"fixed"});
						//$('.d_buttons').button();
					},
					buttons:
					[{
    ...
    if ($('.sortable.nav').length) {
		...
		function set_tree(){
			...
			$('.remove_menu_item').off().on('click', function() {
    ...
    if ($('a[href$="/geometrics/new.castle"]').length) {
        $('a[href$="/geometrics/new.castle"]').on('click', function (e) {
            ...
            if ($("#choosegType").length == 0) {
                $("body").append('<div id="choosegType" title="Choose the place model">' + '<p><strong>Choose a type</strong>' + 'that the style will be for.</p>' + '</div>');
            }
            $("#choosegType").dialog({
                autoOpen: true,
                height: 275,
                ...
                draggable: false,
                buttons: {
                    /*"Marker": function() {					window.location = "/geometrics/new.castle?type=1"				},*/
                    "Polyline": function () {
                        window.location = "/geometrics/new.castle?type=2"
                    },
                    "Polygon": function () {
                        window.location = "/geometrics/new.castle?type=3"
                    } /*,				"Rectangle": function() {					window.location = "/geometrics/new.castle?type=4"				},				"Circle": function() {					window.location = "/geometrics/new.castle?type=5"				}*/
                }
            });
        });
    }
    if ($('a[href$="/geometrics/new_style.castle"]').length) {
        $('a[href$="/geometrics/new_style.castle"]').on('click', function (e) {
            ...
            if ($("#chooseSType").length == 0) {
                $("body").append('<div id="chooseSType" title="Choose the place model">' + '<p><strong>Choose a type</strong>' + 'that the style will be for.</p>' + '</div>');
            }
            $("#chooseSType").dialog({
                autoOpen: true,
                height: 275,
                ...
                resizable: false,
                draggable: false,
                buttons: { /*"Marker": function() {					window.location = "/geometrics/new_style.castle?type=1"				},*/
                    "Polyline": function () {
                        window.location = "/geometrics/new_style.castle?type=2"
                    },
                    "Polygon": function () {
                        window.location = "/geometrics/new_style.castle?type=3"
                    } /*,				"Rectangle": function() {					window.location = "/geometrics/new_style.castle?type=4"				},				"Circle": function() {					window.location = "/geometrics/new_style.castle?type=5"				}*/
                }
            });
        });
    }
